package org.jeecg.modules.demo.askforleave.rule;
 ...
 * @author naiyu
 */
public class AskForLeaveCodeRule implements IFillRuleHandler {
    ...
    public Object execute(JSONObject params, JSONObject formData) {
        ...
        return StrFormatter.format("Q{}{}", timestamp, NumberUtil.decimalFormat("0000", increment));
    }
